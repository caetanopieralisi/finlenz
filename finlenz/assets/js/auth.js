...
// Em alguns WebViews (ex.: App Inventor) a escrita no localStorage pode
// atrasar alguns instantes em relação à resposta do login.
async function goToAppWhenSessionReady(){
  ...
  alert("Login feito, mas o app não conseguiu confirmar a sessão salva neste navegador/WebView. Verifique se o WebViewer permite armazenamento local (DOM storage / localStorage).");
}
...
document.getElementById("demoBtn").addEventListener("click", async () => {
  ...
  try {
    ...
    alert("Erro inesperado ao entrar na conta demo: " + err.message);
    btn.disabled = false;
